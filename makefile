...
#static libs
AWFMINDEX_STATIC_LIB_BUILD_SRC			= $(LIBDIVSUFSORT_BUILD_DIR)/$(AWFMINDEX_STATIC_LIB_FILENAME)
...
$(LIBDIVSUFSORT_STATIC_LIB_BUILD_SRC): $(LIBDIVSUFSORT_BUILD_DIR)
	cd $(LIBDIVSUFSORT_BUILD_DIR) &&	cmake -DCMAKE_BUILD_TYPE="Release" -DUSE_OPENMP="ON" -DBUILD_SHARED_LIBS="OFF" -DBUILD_DIVSUFSORT64:BOOL=ON  -DCMAKE_INSTALL_PREFIX="$(PREFIX)" .. && make install
