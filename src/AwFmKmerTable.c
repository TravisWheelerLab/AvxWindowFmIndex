...
Ideas as to how to fix this and get it working:
	...
	The size of the tables will increase, and as a result, the size of the seeds will likely have to be 1 smaller in
practice. instead of 4^n * 16 bytes for a nucleotide table with length n, the new size would be 5^n * 16.  However, at
that point, searching for the smaller kmers becomes much easier.
